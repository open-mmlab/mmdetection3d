...
最新的 **1.0.0rc8** 版本已经在 2023.3.26 发布。

### 🌟 1.1.x 预览版本

全新的 **v1.1.0rc4** 版本已经在 2023.3.26 发布：
...
我们已经支持了更多基于 LiDAR 的 3D 分割算法, 包括 Cylinder3d, MinkUNet 和 SPVCNN。更多关于 3D 感知的新特性正在开发中！
...
最新的版本 v1.0.0rc8 在 2023.3.26 发布。
