...
# Decoder's
from .km_mono3d_decoder import *

INF = 1e8


@HEADS.register_module()
class KM3DHead(AnchorFreeMono3DHead):
    """Anchor-free head used in KM3D.
    ...
    def forward_single(self, x, scale, stride):
        ...
        assert self.norm_on_bbox is True, 'Setting norm_on_bbox to False '\
            'has not been thoroughly tested for KM3D.'
    ...
    def _get_target_single(self, gt_bboxes, gt_labels, gt_bboxes_3d,
        ...
        assert self.center_sampling is True, 'Setting center_sampling to '\
            'False has not been implemented for KM3D.'
