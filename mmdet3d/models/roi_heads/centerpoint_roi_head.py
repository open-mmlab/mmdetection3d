...
class CenterPointRoIHead(Base3DRoIHead):
    ...
    Args:
        ...
        train_cfg (dict, opional): Config of the training. Defaults to None.
        test_cfg (dict, optional): Config of the testing. Defaults to None.
        pretrained (dict, optional): Config of the pretrained model. Defaults
            to None.
    ...
    def simple_test(self, bev_feature, img_metas, rois):
        ...
        Returns:
            list[dict[str, torch.Tensor]]: Bounding box results in cpu mode.
                ...
                - boxes_3d (:obj:`BaseInstance3DBoxes`): 3D boxes with shape
                    of [N, box_size].
                - scores_3d (torch.Tensor): Prediction scores with shape of
                    [N].
                - labels_3d (torch.Tensor): Box labels with shape of [N].
