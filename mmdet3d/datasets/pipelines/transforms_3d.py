...
class RandomFlip3D(RandomFlip):
    ...
    def __call__(self, input_dict):
        ...
        if 'transformation_3d_pipeline' not in input_dict.keys():
            input_dict['transformation_3d_pipeline'] = ''

        if input_dict['pcd_horizontal_flip']:
            self.random_flip_data_3d(input_dict, 'horizontal')
            input_dict['transformation_3d_pipeline'] += 'H'
        if input_dict['pcd_vertical_flip']:
            self.random_flip_data_3d(input_dict, 'vertical')
            input_dict['transformation_3d_pipeline'] += 'V'
        return input_dict
...
class GlobalRotScaleTrans(object):
    ...
    def __call__(self, input_dict):
        ...
        input_dict['transformation_3d_pipeline'] += 'RST'
        return input_dict
