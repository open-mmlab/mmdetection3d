...
def main():
    ...
    inputs = call_args.pop('inputs')
    _, _, visualize_kwargs, _ = inferencer._dispatch_kwargs(**call_args)
    inputs = inferencer._inputs_to_list(inputs)
    inferencer.visualize_preds_fromfile(inputs, ['outputs/preds/000008.json'],
                                        **visualize_kwargs)
