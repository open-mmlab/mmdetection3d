...
```
Remember to convert the VoteNet checkpoint if you are using mmdetection3d version >= 0.6.0. See its README file for detailed instructions on how to convert the checkpoint.
