    ...
    bbox_0 = torch.tensor([[
        ...
        4.40900000e+00, 1.54800000e+00, -1.48801203e+00
                           ...
                           [
                               ...
                               2.39600000e+00, 3.96900000e+00, 1.73200000e+00,
                               -4.65203216e+00
                           ]])
    bbox_1 = torch.tensor([[
        -2.66751588e+01, 5.59499564e+00, -9.14345860e-01, 3.43000000e-01,
        4.58000000e-01, 7.82000000e-01, -4.62759755e+00
                           ...
                           [
                               ...
                               -1.94612112e-01, 1.94400000e+00, 3.85700000e+00,
                               1.72300000e+00, -2.81427027e+00
                           ]])
    bbox_list = [bbox_0, bbox_1]
    rois = bbox3d2roi(bbox_list)
    expected_rois = torch.tensor(
        [[0.0000, -5.2422, 40.0210, 0.2976, 2.0620, 4.4090, 1.5480, -1.4880],
         [0.0000, -5.8098, 35.4092, 0.2009, 2.3960, 3.9690, 1.7320, -4.6520],
         [1.0000, -26.6752, 5.5950, -0.9143, 0.3430, 0.4580, 0.7820, -4.6276],
         [1.0000, -31.3087, 1.0901, -0.1946, 1.9440, 3.8570, 1.7230, -2.8143]])
    assert torch.allclose(rois, expected_rois, atol=1e-4)
