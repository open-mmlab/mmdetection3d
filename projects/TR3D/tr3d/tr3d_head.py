...
class TR3DHead(Base3DDenseHead):
    r"""Bbox head of `TR3D <https://arxiv.org/abs/2112.00322>`_.
    ...
    def __init__(self,
                 ...
                 bbox_loss: dict = dict(
                    type='TR3DAxisAlignedIoULoss', mode='diou',
                    reduction='none'),
                 cls_loss: dict = dict(
    ...
    def _init_layers(self, num_classes, in_channels, num_reg_outs):
    ...
    def _loss_by_feat_single(self, bbox_preds: List[Tensor],
        ...
        bbox_targets, cls_targets = self._get_targets(
    ...
    def loss_by_feat(self, bbox_preds: List[List[Tensor]],
                     cls_preds: List[List[Tensor]], points: List[List[Tensor]],
        ...
        Args:
            ...
            batch_input_metas (list[dict]): Meta information of each image, e.g.,
