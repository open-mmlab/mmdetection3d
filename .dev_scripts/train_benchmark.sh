...
GPUS=8 GPUS_PER_NODE=8 CPUS_PER_TASK=5 ./tools/slurm_train.sh $PARTITION hv_pointpillars_regnet-1.6gf_fpn_sbn-all_free-anchor_strong-aug_4x8_3x_nus-3d configs/free_anchor/pointpillars_hv-regnet-1.6gf_fpn_head-free-anchor_8xb4-3x_nus-3d_strong-aug.py \
$CHECKPOINT_DIR/configs/free_anchor/pointpillars_hv-regnet-1.6gf_fpn_head-free-anchor_8xb4-3x_nus-3d_strong-aug.py --cfg-options checkpoint_config.max_keep_ckpts=1 \
