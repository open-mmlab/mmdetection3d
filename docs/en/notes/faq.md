...
- Compatibility issue between MMCV, MMDetection and MMDetection3D; "ConvWS is already registered in conv layer"; "AssertionError: MMCV==xxx is used but incompatible. Please install mmcv>=xxx, \<=xxx."
  ...
  | :-------------------: | :----------------------: | :--------------------------: | :----------------------: |
  |        dev-1.x        | mmengine>=0.1.0, \<0.2.0 | mmcv-full>=2.0.0rc0, \<2.1.0 | mmdet>=3.0.0rc0, \<3.1.0 |
  |       v1.1.0rc0       | mmengine>=0.1.0, \<0.2.0 | mmcv-full>=2.0.0rc0, \<2.1.0 | mmdet>=3.0.0rc0, \<3.1.0 |
