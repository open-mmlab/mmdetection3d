...
\-----------------------| :-------------------: | :----------------------: | :---------------------: | :----------------------: |
| dev-1.x               | mmengine>=0.1.0, \<0.2.0 | mmcv>=2.0.0rc0, \<2.0.0rc2 | mmdet>=3.0.0rc0, \<3.0.0rc2 |
| v1.1.0rc1             | mmengine>=0.1.0, \<0.2.0 | mmcv>=2.0.0rc0, \<2.0.0rc2 | mmdet>=3.0.0rc0, \<3.0.0rc2 |
