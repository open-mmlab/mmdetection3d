...
As in the [baseline config](pointpillars_hv_fpn_head-free-anchor_8xb4-2x_nus-3d.py), we only need to replace the head of an existing one-stage detector to use FreeAnchor head.
