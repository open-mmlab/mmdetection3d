_base_ = [
    '../_base_/datasets/waymoD3-mono3d-3class.py', '../_base_/models/pgd.py',
...
train_dataloader = dict(dataset=dict(ann_file='waymo_infos_val.pkl'))
val_dataloader = dict(dataset=dict(ann_file='waymo_infos_val.pkl'))
test_dataloader = dict(dataset=dict(ann_file='waymo_infos_val.pkl'))
