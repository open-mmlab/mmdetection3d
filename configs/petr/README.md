...
```bash
python tools/train.py configs/projects/dummy_PETR/config/petr/petr_vovnet_gridmask_p4_800x320.py
```
...
```bash
python tools/test.py config/petr/petr_vovnet_gridmask_p4_800x320.py ${CHECKPOINT_PATH}
```
...
| :--------------------------------------------------------------------------------: | :-----: | :------: | :------------: | :--: | :--: | :----------------------: |
| [petr_vovnet_gridmask_p4_800x320](configs/petr/petr_vovnet_gridmask_p4_800x320.py) |   1x    |   7.62   |      18.7      | 38.3 | 43.5 | [model](<>) \| [log](<>) |
